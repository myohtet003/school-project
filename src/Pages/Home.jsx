	...
	<div className='flex items-center justify-between px-5 py-2 my-5 rounded'>
        ...
        <div className=" container mx-auto ps-4 pt-32 gap-10 flex justify-between">
          <div className=" basis-1/2  ">
            <div className="">
              ...
              <p className="my-8 text-lg  text-para-text-color pl-5 border-l-4 border-primary">
              Learning record store (lrs) bite-sized learning avatar {" "} <br></br> elearning, multimedia scenario serious games
              </p>
            </div>
            <div className="hidden md:flex items-start justify-between gap-8 flex-1 mt-8">
              <div className="">
                <img className=' max-h-[100%] rounded-2xl' src="../Images/gallery-12-1.jpg" alt="" />
              </div>
              ...
              <div className=" flex justify-between items-center">
                <div className="flex gap-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className=' ps-3 text-secondary text-sm font-semibold'>11AM to 15PM</div>
                  </div> 
                </div>
                <div className=" text-primary text-xl font-bold">$16</div>
              </div>
              <div className=" mt-5 text-gray hover:text-primary text-2xl font-bold">Environment Conference</div>
              <div className="flex mt-3 items-center">
                <CiLocationOn className=' text-primary mr-2'/>
                <p className=' text-gray text-lg font-medium'>9 Grafton St, Worcester</p>
              </div>
            </div>
              ...
              <div className=" flex justify-between items-center">
                <div className="flex gap-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className=' ps-3 text-secondary text-sm font-semibold'>17:00</div>
                  </div> 
                </div>
                <div className=" text-primary text-xl font-bold">$free</div>
              </div>
              <div className=" mt-5 text-gray hover:text-primary text-2xl font-bold">Digital Transformation Conference</div>
              <div className="flex mt-3 items-center">
                <CiLocationOn className=' text-primary mr-2'/>
                <p className=' text-gray text-lg font-medium'>88 Grafton St, Worcester</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className=' pt-32'>
        <div className=" container mx-auto ">
              <div className=" flex justify-center">
                ...
                <div className=" text-center">
                  <p className='text-gray font-bold text-5xl'>Our <span className=' text-primary'>Classes</span></p>
                  <p className=" mt-8 text-gray font-normal text-lg">Application programming interface voice-over (vo) instructor led training
                  <br></br>curation, user created content</p>
                </div>
              </div>
        </div>
      ...
      <section className=' pt-12 px-[5rem]'>
        <div className=" container mx-auto ">
          <div className=" flex justify-center">
            ...
            <div className=" text-center">
              <p className='text-gray font-bold text-5xl'>Study Process <span className=' text-primary'> Gallery</span></p>
              <p className=" mt-8 text-gray font-normal text-lg">Instructor led training digital learning cbt completion criteria learning
              <br></br>management system cognitive load byod self-directed learning knowledge</p>
            </div>
          </div>
            ...
            <div className=" w-[17%] h-[30rem] relative ">
              <div className="w-20 h-16 bg-orange group bg-opacity-0 group-hover:bg-opacity-30 group-hover:z-10 top-28 right-0 absolute rounded-xl overflow-hidden duration-200">
                <div className=" w-full h-full">
                  ...
                  <img src="../Images/gallery10-1.jpg" className=' object-cover h-[100%] rounded-lg group-hover:scale-110 duration-200' alt="" />
                </div>
              </div>
              <div className=" w-40 h-[16rem] bg-orange group bg-opacity-0 group-hover:bg-opacity-30 group-hover:z-10 bottom-7 right-0 absolute rounded-xl overflow-hidden duration-200">
                <div className=" w-full h-full">
                  ...
                  <img src="../Images/gallery10.2.jpg" className=' object-cover h-[100%] rounded-lg group-hover:scale-110 duration-200' alt="" />
                </div>
              </div>
            </div>
            <div className=" w-[22%] h-[30rem] relative">
              <div className=" h-[20rem] bg-orange group bg-opacity-0 group-hover:bg-opacity-30 
              group-hover:z-10 top-0 left-0 
              absolute rounded-xl overflow-hidden duration-200">
                  <div className=" w-full h-full">
                    
                  <img src="../Images/gallery10-3.jpg" className=' object-cover h-[100%] rounded-lg group-hover:scale-110 duration-200' alt="" />
                  </div>
                </div>
                <div className=" w-[12rem] h-[9rem] bg-orange group bg-opacity-0 
                group-hover:bg-opacity-30 group-hover:z-10 bottom-0 
                left-0 absolute rounded-xl overflow-hidden duration-200">
                  <div className=" w-full h-full">
                    
                    <img src="../Images/gallery10-4.png" className=' object-cover h-[100%] rounded-lg group-hover:scale-110 duration-200' alt="" />
                  </div>
                </div>
            </div>
            <div className=" w-[13%] h-[30rem] relative ">
              <div className="w-40 h-[16rem] bg-orange group bg-opacity-0 group-hover:bg-opacity-30 group-hover:z-10 top-7 left-0 absolute rounded-xl overflow-hidden duration-200 float-right">
                <div className=" w-full h-full">
                  ...
                  <img src="../Images/gallery10-5.jpg" className=' object-cover h-[100%] rounded-lg group-hover:scale-110 duration-200' alt="" />
                </div>
              </div>
              <div className=" w-[7rem] h-[7rem] bg-orange group bg-opacity-0 group-hover:bg-opacity-30 group-hover:z-10 bottom-16 left-0 absolute rounded-xl overflow-hidden duration-200 float-right">
                <div className=" w-full h-full">
                  ...
                  <img src="../Images/gallery10-6.jpg" className=' object-cover h-[100%] rounded-lg group-hover:scale-110 duration-200' alt="" />
                </div>
              </div>
            </div>
            <div className=" w-[15%] h-[30rem] relative ">
              <div className="w-[7rem] h-[5rem] bg-orange group bg-opacity-0 group-hover:bg-opacity-30 group-hover:z-10 top-16 left-0 absolute rounded-xl overflow-hidden duration-200 float-right">
                <div className=" w-full h-full">
                  ...
                  <img src="../Images/gallery10-7.jpg" className=' object-cover h-[100%] rounded-lg group-hover:scale-110 duration-200' alt="" />
                </div>
              </div>
              <div className=" w-46 h-[15rem] bg-orange group bg-opacity-0 group-hover:bg-opacity-30 group-hover:z-10 bottom-20 left-0 absolute rounded-xl overflow-hidden duration-200 float-right">
                <div className=" w-full h-full">
                  ...
                  <img src="../Images/gallery10-8.jpg" className=' object-cover h-[100%] rounded-lg group-hover:scale-110 duration-200' alt="" />
                </div>
              </div>
            </div>
            <div className=" w-[15%] h-[30rem] relative ">
              <div className="w-[17rem] h-[12rem] bg-orange group bg-opacity-0 group-hover:bg-opacity-30 group-hover:z-10 top-0 let-0 absolute rounded-xl overflow-hidden duration-200 float-right">
                <div className=" w-full h-full">
                  ...
                  <img src="../Images/gallery10-9.jpg" className=' object-cover h-[100%] rounded-lg group-hover:scale-110 duration-200' alt="" />
                </div>
              </div>
              <div className=" w-52 h-[14rem] bg-orange group bg-opacity-0 group-hover:bg-opacity-30 group-hover:z-10 bottom-12 left-0 absolute rounded-xl overflow-hidden duration-200 float-right">
                <div className=" w-full h-full">
                  ...
                  <img src="../Images/gallery10-10.jpg" className=' object-cover h-[100%] rounded-lg group-hover:scale-110 duration-200' alt="" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className='pt-12 px-[5rem]'>
            <div className="container mx-auto ">
              <div className=" flex justify-center">
                <div className=" text-center">
                  <p className='text-gray font-bold text-5xl'>Our Awesome <span className=' text-primary'> Teachers</span></p>
                  <p className=" mt-8 text-gray font-normal text-lg">Rapid learning rapid authoring tools web based training (wbt) informal
                  <br></br>learning virtual classroom, roi instructional designer big data</p>
                </div>
              </div>
              <div className="flex items-center justify-between gap-6 mt-8">
                <div className="xl:basis-1/4 basis-[48%] ">
                  ...
                  <div className="text-center">
                    <h6 className="text-2xl text-gray font-semibold hover:text-primary mt-6">Polina Kerston</h6>
